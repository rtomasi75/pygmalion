namespace pygmalion::chess
{
	...
	public:
		PYGMALION_TUNABLE static inline scoreType Attack{ static_cast<scoreType>(0.125 / 64.0) };
	private:
		...
		{
			return parameterType(Attack, static_cast<scoreType>(0.0), static_cast<scoreType>(1.0), static_cast<scoreType>(0.001), "term_attack");
		}
