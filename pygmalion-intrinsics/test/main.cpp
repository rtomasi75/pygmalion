...
int main(int argc, char* argv[])
{
	...
	T v3 = v1 & v2;
	T v4 = v1 | v2;
	T v5{ unsigned_integer<len,compact>::random() };
	T v6 = v1;
	v6+=v5;
	std::cout << "popc: " << T::countWords << " x " << integer_intrinsics::popcount_name<typename T::wordType>() << std::endl;
