namespace pygmalion
{
	...
	template<size_t COUNT, size_t HASHBITS, typename INSTANCE, typename SET>
	class enumeration :
		public enumeration<COUNT,HASHBITS,INSTANCE,void>
	{
	private:
	...
	public:
		...
		using setType = SET;
		using baseType = typename enumeration<COUNT, HASHBITS, INSTANCE, void>::baseType;
		using valueType = typename enumeration<COUNT, HASHBITS, INSTANCE, void>::valueType;
	protected:
		...
		PYGMALION_INLINE constexpr enumeration() noexcept = default;
		PYGMALION_INLINE constexpr enumeration(const baseType& value) noexcept :
			enumeration<COUNT, HASHBITS, INSTANCE, void>(value)
		{
		}
	...
	public:
		PYGMALION_INLINE constexpr setType operator|(const instanceType other) const noexcept
		{
			return other | *static_cast<instanceType*>(this);
		}
		PYGMALION_INLINE constexpr setType operator&(const instanceType other) const noexcept
		{
			return other & *static_cast<instanceType*>(this);
	...
	class enumeration<COUNT,HASHBITS,INSTANCE,void>
	{
	private:
		constexpr static size_t requiredSignedBytes(const size_t number) noexcept
		{
