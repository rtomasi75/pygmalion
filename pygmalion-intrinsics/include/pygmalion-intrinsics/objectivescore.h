namespace pygmalion
{
	...
	public:
		PYGMALION_INLINE constexpr bool operator==(const objectivescore& other) const noexcept
		{
		...
		PYGMALION_INLINE constexpr objectivescore() noexcept :
		...
		PYGMALION_INLINE constexpr objectivescore(const objectivescore&) noexcept = default;
		PYGMALION_INLINE constexpr objectivescore(objectivescore&&) noexcept = default;
		PYGMALION_INLINE constexpr objectivescore& operator=(const objectivescore&) noexcept = default;
		PYGMALION_INLINE constexpr objectivescore& operator=(objectivescore&&) noexcept = default;
		PYGMALION_INLINE constexpr const subjectiveType& player(const size_t playerIndex) const noexcept
		{
			return m_PlayerScores[playerIndex];
		}
		PYGMALION_INLINE constexpr subjectiveType& player(const size_t playerIndex) noexcept
		{
			return m_PlayerScores[playerIndex];
		}
		template<size_t PLAYER>
		PYGMALION_INLINE constexpr const subjectiveType& player() const noexcept
		{
			return m_PlayerScores[PLAYER];
		}
		template<size_t PLAYER>
		PYGMALION_INLINE constexpr subjectiveType& player() noexcept
		{
			return m_PlayerScores[PLAYER];
		}
		PYGMALION_INLINE constexpr objectivescore& operator+=(const objectivescore& other) noexcept
		{
			for (size_t i = 0; i < countPlayers; i++)
		...
		PYGMALION_INLINE constexpr objectivescore operator+(const objectivescore& other) const
		{
		...
		PYGMALION_INLINE constexpr objectivescore operator-() const
		{
		...
		PYGMALION_INLINE constexpr subjectiveType makeSubjective(const size_t playerIndex) const noexcept
		{
		...
		template<size_t PLAYER>
		PYGMALION_INLINE constexpr subjectiveType makeSubjective() const noexcept
		{
			constexpr const subjectiveType zero{ subjectiveType::zero() };
			subjectiveType subjective{ zero };
			for (size_t i = 0; i < countPlayers; i++)
		...
		PYGMALION_INLINE constexpr static objectivescore makeObjective(const subjectiveType sc, const size_t playerIndex) noexcept
		{
		...
		template<size_t PLAYER>
		PYGMALION_INLINE constexpr static objectivescore makeObjective(const subjectiveType sc) noexcept
		{
			objectivescore result;
			result.m_PlayerScores[PLAYER] = sc;
			return result;
		}
		PYGMALION_INLINE constexpr static inline objectivescore<SCORE, COUNTPLAYERS> zero() noexcept
		{
	...
	public:
		...
		PYGMALION_INLINE constexpr static inline objectivescore<SCORE, 2> zero() noexcept
		{
