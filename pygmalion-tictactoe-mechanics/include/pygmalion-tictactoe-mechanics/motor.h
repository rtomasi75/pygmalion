...
{
	using basemove = pygmalion::mechanics::disjunctivemove<board, pygmalion::mechanics::nullmove<board>, pygmalion::mechanics::dropmove<board>, pygmalion::mechanics::transportmove<board>, pygmalion::mechanics::capturemove<board>>;
