namespace pygmalion::state
{
	...
	class player :
		public enumeration<DESCRIPTION_STATE::countPlayers, player<DESCRIPTION_STATE>>,
		public DESCRIPTION_STATE
	{
	public:
		using parentType = enumeration<DESCRIPTION_STATE::countPlayers, player<DESCRIPTION_STATE>>;
