				...
				if (squareType::parse(token, count, sq))
				{
					...
					case king:
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "king untabled quiet moves from " << sq.toShortString() << ":" << std::endl;
						...
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "king untabled capture moves from " << sq.toShortString() << ":" << std::endl;
						dumpSquares(generatorType::movegenKing.untabled_attacks(sq, ~position().totalOccupancy()) & position().playerOccupancy(p.next()));
						this->output() << std::endl;
						this->output() << "king untabled inverse quiet moves from " << sq.toShortString() << ":" << std::endl;
						...
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "king untabled inverse capture moves from " << sq.toShortString() << ":" << std::endl;
					...
					case knight:
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "knight untabled quiet moves from " << sq.toShortString() << ":" << std::endl;
						...
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "knight untabled capture moves from " << sq.toShortString() << ":" << std::endl;
						...
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "knight untabled inverse quiet moves from " << sq.toShortString() << ":" << std::endl;
						...
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "knight untabled inverse capture moves from " << sq.toShortString() << ":" << std::endl;
					...
					case rook:
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "rook relevant squares from " << sq.toShortString() << ":" << std::endl;
						...
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "rook inverse relevant squares from " << sq.toShortString() << ":" << std::endl;
						...
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "rook inverse quiet moves from " << sq.toShortString() << ":" << std::endl;
						...
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "rook inverse capture moves from " << sq.toShortString() << ":" << std::endl;
					...
					case bishop:
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "bishop relevant squares from " << sq.toShortString() << ":" << std::endl;
						...
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "bishop inverse relevant squares from " << sq.toShortString() << ":" << std::endl;
						...
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "bishop inverse quiet moves from " << sq.toShortString() << ":" << std::endl;
						...
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "bishop inverse capture moves from " << sq.toShortString() << ":" << std::endl;
					...
					case queen:
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "queen relevant squares from " << sq.toShortString() << ":" << std::endl;
						...
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "queen inverse relevant squares from " << sq.toShortString() << ":" << std::endl;
						...
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "queen inverse quiet moves from " << sq.toShortString() << ":" << std::endl;
						...
						if (p == whitePlayer)
							...
							this->output() << "black ";
						this->output() << "queen inverse capture moves from " << sq.toShortString() << ":" << std::endl;
