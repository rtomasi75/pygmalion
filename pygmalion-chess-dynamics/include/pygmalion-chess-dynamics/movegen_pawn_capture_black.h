...
{
	class propagator_pawn_capture_black:
		public pygmalion::dynamics::propagator<descriptor_dynamics, 1, propagator_pawn_capture_black, pygmalion::dynamics::ray<1, -1>, pygmalion::dynamics::ray<-1, -1>>
	{};
