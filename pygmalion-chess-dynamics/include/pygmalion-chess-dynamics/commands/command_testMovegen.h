	...
	private:
		...
		static inline testset m_Sets[]
		{
			...
			//	testset("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 9, UINTMAX_C(2439530234167)),
				testset("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -",1, UINTMAX_C(48)),
				testset("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -",2, UINTMAX_C(2039)),
				testset("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -",3, UINTMAX_C(97862)),
				testset("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -",4, UINTMAX_C(4085603)),
				testset("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -",5, UINTMAX_C(193690690)),
				testset("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -",6, UINTMAX_C(8031647685)),
				testset("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -", 1, UINTMAX_C(14)),
				testset("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -", 2, UINTMAX_C(191)),
				testset("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -", 3, UINTMAX_C(2812)),
			...
			if constexpr (PLAYER < countPlayers)
			{
				...
				if (player == this->position().movingPlayer())
				{
					...
					for (size_t i = 0; i < n; i++)
					{
						...
						{
							bPassed &= this->template test<PLAYER>(m_Sets[i], nodes, duration);
							this->output() << std::endl;
							if (!bPassed)
								break;
						}
