namespace pygmalion::tictactoe
{
	...
	using descriptor_search = pygmalion::descriptor_search<evaluator, 10, searchOptions, countTranspositionTableBuckets, countQuietKillerMoveSlots, countTacticalKillerMoveSlots, killerMovesLookBackDistance, 0, 0, 0, lateMoveReductionPlies, lateMoveReductionMinDepth, heuristics>;
}
