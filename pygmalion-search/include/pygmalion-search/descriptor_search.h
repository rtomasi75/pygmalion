namespace pygmalion
{
	...
	template<typename EVALUATOR, size_t COUNT_SEARCH_PLIES, unsigned int SEARCH_FLAGS, size_t COUNT_TT_BUCKETS, size_t KILLER_MOVES_QUIET, size_t KILLER_MOVES_TACTICAL, size_t KILLER_LOOKBACK_DISTANCE, size_t COUNT_QS1_PLIES, size_t COUNT_QS2_PLIES, size_t COUNT_QS3_PLIES, size_t COUNT_LATEMOVE_REDUCTION, size_t LATEMOVE_REDUCTION_MINDEPTH, typename HEURISTICS>
	...
	public:
		...
		constexpr static const depthType countQsPhase1Plies{ depthType(COUNT_QS1_PLIES) };
		constexpr static const depthType countQsPhase2Plies{ depthType(COUNT_QS2_PLIES) };
		constexpr static const depthType countQsPhase3Plies{ depthType(COUNT_QS3_PLIES) };
